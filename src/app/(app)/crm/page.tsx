      ...
      <div className="p-4 sm:p-5">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Callback banner — always visible, no need to expand Notes to see it */}
            {lead.status === 'callback' && (
              <div className="mt-2.5 flex items-center justify-between bg-orange-50 border border-orange-200 rounded-xl px-3 py-2">
                <div className="flex items-center gap-2">
                  <Calendar className="w-3.5 h-3.5 text-orange-500 shrink-0" />
                  <div>
                    <p className="text-[10px] font-bold text-orange-500 uppercase tracking-wide leading-none mb-0.5">Rappel planifié</p>
                    <p className="text-[12.5px] font-semibold text-orange-800 leading-none">
                      {lead.callback_date
                ...
                <button onClick={() => setShowCallback(true)}
                  className="flex items-center gap-1.5 text-[11.5px] font-semibold text-orange-700 bg-white border border-orange-200 rounded-lg px-2.5 py-1 hover:bg-orange-100 transition-colors shrink-0">
                  <Calendar className="w-3 h-3" /> Modifier
                </button>
              </div>
            )}
